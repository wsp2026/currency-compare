...
export const CHANNELS: ChannelConfig[] = [
  ...
  },
  {
    ...
    type: 'crypto',
    dataSourceType: 'market-api',
    dataSourceNote: '实时行情来自 Binance Vision 官方 API，USDT ≈ USD，C2C 约+0.3%溢价，VIP 可享 0.1% 费率',
    channelKey: 'usdt_binance',
    rateMarkup: 0,
    feeRate: 0.001,
    feeMin: 0,
    feeMax: Infinity,
    feeDesc: '标准0.1%交易费（持BNB可享8折）+ C2C约0.3%溢价',
    officialUrl: 'https://www.binance.com/zh-CN/fee/schedule',
    exchangeUrl: 'https://www.binance.com/zh-CN/buy-sell-crypto',
  },
]
